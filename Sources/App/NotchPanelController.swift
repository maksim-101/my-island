...
final class NotchPanelController: NSObject {
    ...
    override init() {
        ...
        for screen in NSScreen.screens {
            ...
            let panel = Self.makePanel(notchFrame: notchFrame, screen: screen)
            panels.append(panel)
    ...
    private static func makePanel(notchFrame: NSRect, screen: NSScreen) -> NotchPanel {
    ...
    func toggle() {
        // Real hover/hotkey-driven expand-collapse behavior lands in Plan 02/03.
    }
}
